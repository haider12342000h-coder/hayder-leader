function AdminFilterBar({ searchValue, onSearchChange, activeFilter, onFilterChange, filters }) {
  return (
    <section className="rounded-[28px] border border-white/80 bg-white/95 p-4 shadow-soft backdrop-blur-xl">
